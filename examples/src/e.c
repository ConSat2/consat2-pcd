...
int main( int argc, char *argv[] )
{
	...
	printf( "Application 'e' started, initializing...\n" );
	...
	printf( "'e' init done, val = %d\n", val );
	printf( "'e' is sending PROCESS READY event to the PCD...\n" );
	...
	printf( "'e' is entering an endless loop..." );
